...
def train_opts(parser):
    ...
    group.add_argument('-save_checkpoint_steps', type=int, default=2000,
    ...
    group.add_argument('-log_file', type=str, default="trainlog.txt",
                       help="Output logs to a file under this path.")
...
def translate_opts(parser):
    ...
    group.add_argument('-model', dest='models', metavar='MODEL',
                       nargs='+', type=str, default=["pretrained_model_ppl_3881.pt"],
    ...
    group.add_argument('-src', default="fwd-tok.txt",
    ...
    group.add_argument('-output', default='fwd-pred.txt',
    ...
    group.add_argument('-replace_unk', default=True, action="store_true",
