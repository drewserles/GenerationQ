...
def build_translator(opt, report_score=True, logger=None, out_file=None):
    ...
    if len(opt.models) > 1:
        ...
        # I believe this is where the pretrained model is loaded.
        fields, model, model_opt = \
    ...
    translator = Translator(model, fields, global_scorer=scorer,
                            out_file=None, report_score=report_score,
                            copy_attn=model_opt.copy_attn, logger=logger, out_path=opt.output,
                            **kwargs)
    return translator
...
class Translator(object):
    ...
    def __init__(self,
        ...
        self.out_path = out_path # Keep the path (this is an opts value)
    ...
    def translate(self,
        ...
        # Can I add in the file open here instead? 
        self.out_file = codecs.open(self.out_path, 'w+', 'utf-8')
        ...
        for batch in data_iter:
            ...
            for trans in translations:
                ...
                self.out_file.write('\n'.join(n_best_preds) + '\n')
                #self.out_file.write(str(float(trans.pred_scores[0]))  + '\n')
                self.out_file.write(f'{float(trans.pred_scores[0]):.4f}\n')
                self.out_file.flush()
